...
public class ShowPrescriptionsScreen extends AppCompatActivity {

    private RecyclerView mRecyclerView;
    private ShowPrescriptionAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_prescriptions_screen);

        bindViews();
        initialize();

        String pharmacist_id = DatabaseHelper.getInstance(getBaseContext()).getPharmacist().get(0).getId();
        Log.d(Constants.DEBUG_TAG, String.valueOf(pharmacist_id));
       // getReportRequest(Constants.PATIENT_REPORT_URL,patient_id);
        //mProgressBar.setVisibility(View.VISIBLE);
    }

    private void bindViews() {
        mRecyclerView = findViewById(R.id.recycler_view_show_prescription_screen);
        mProgressBar = findViewById(R.id.progressBar_show_prescription_screen);
...
/*
        prescriptionArrayList.add(new Prescription("asd","asd","asd","asd","asd","asd","asd","asd"));
        prescriptionArrayList.add(new Prescription("asd","asd","asd","asd","asd","asd","asd","asd"));
        prescriptionArrayList.add(new Prescription("asd","asd","asd","asd","asd","asd","asd","asd"));
        prescriptionArrayList.add(new Prescription("asd","asd","asd","asd","asd","asd","asd","asd"));
 ...
 */       mLayoutManager = new LinearLayoutManager(getBaseContext()); //creating recyclerView layout
        ...
        mAdapter = new ShowPrescriptionAdapter(this, prescriptionArrayList, new ShowPrescriptionAdapter.OnListItemChangeCallBack() {
            @Override
            public void onSuccess(String patientID) {
                mRecyclerView.refreshDrawableState();
            }
        }); //creating adapter or calling it
